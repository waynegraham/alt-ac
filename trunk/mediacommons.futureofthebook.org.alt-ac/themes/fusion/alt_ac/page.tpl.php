  ...
  <div id="page" class="page">
    <div id="page-inner" class="page-inner">
      ...
      <!-- header-group row: width = grid_width -->
        ...
        <div id="logo-menu-search" class="header-group row <?php print $grid_width; ?>">
			  <div id="logo" class="block grid16-7">
	            <a href="<?php print check_url($front_page); ?>" title="<?php print t('Home'); ?>" class="site-logo"><img src="<?php print $logo; ?>" alt="<?php print t('Home'); ?>" /></a>                
				<?php if ($site_slogan): ?>
				...
				<div id="search-and-links" class="block grid16-6 grid16-indent-3">
				<?php print $user_menu; ?>
				<br />
		...
		<div id="primary-menu-tne" class="row <?php print $grid_width; ?>">
    ...
    <div id="main" class="main row <?php print $grid_width; ?>">
          <div id="main-inner" class="main-inner inner clearfix">
                  ...
                  <div id="main-content-inner" class="main-content-inner inner">
                    ...
                    <div id="content-group" class="content-group row nested <?php print $content_group_width; ?>">
                      <div id="content-group-inner" class="content-group-inner inner">
								...
								<?php /*REMOVED THE BREADCRUMB FOR NOW */ ?>
			...
			<?php if ( $tabs ) { print theme( 'grid_block', $tabs, 'content-tabs' ); } ?>
...
<div id="dev"><?php if ( 1 == 0 ) { print_r( get_defined_vars() ); } ?></div>
    </div><!-- /page-inner -->
